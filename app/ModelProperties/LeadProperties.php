...
class LeadProperties
{
    ...
    public static function all()
    {
        return [
            ...
            /*
             * Contrato ComercioCity: persistidos vía ModelPropertiesHelper pero editados
             * solo en la pestaña extra `LeadContractTab` (`show` => false en el formulario principal).
             */
            [
